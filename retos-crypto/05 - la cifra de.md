...
## Solución
Abrimos el archivo y tenemos el siguiente mensaje
```
Encrypted message:
...
Decodificamos el texto con cifrado Vigenere y sabemos que la clave es flag.
Lo pasamos con cyberchef y tenemos la bandera.
...
https://gchq.github.io/CyberChef/#recipe=Vigen%C3%A8re_Decode('flag')